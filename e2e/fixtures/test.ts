 ...
 * - Desktop viewport by default: Claudia switches to a mobile layout at
 *   <= 768px, where the main panel, terminal and file explorer are not
 *   rendered at all.
 */
...
export const test = base.extend<{
    ...
    viewport: [{ width: 1440, height: 900 }, { option: true }],
});
