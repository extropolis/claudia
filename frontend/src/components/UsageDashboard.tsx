...
export function UsageDashboard({ isOpen, onClose, embedded }: UsageDashboardProps) {
  ...
  const workspaceEntries = data
    ? (Object.entries(data.byWorkspace) as [
        string,
        {
          name: string;
          costUsd: number;
  ...
  const content = (
    <div
      className={embedded ? 'usage-dashboard usage-dashboard-embedded' : 'usage-dashboard'}
      ...
      <div className="usage-dashboard-body">
        ...
        {data && (
          <>
            ...
            <div className="usage-section">
              <button className="usage-pricing-toggle" onClick={() => setShowPricing(!showPricing)}>
                <Settings size={16} />
                          ...
                          <tr key={model}>
                            ...
                            <td>
                              <input
                                ...
                                onChange={(e) =>
                                  updatePricingField(model, 'inputPer1MTokens', e.target.value)
                                }
                            ...
                            <td>
                              <input
                                ...
                                onChange={(e) =>
                                  updatePricingField(model, 'outputPer1MTokens', e.target.value)
                                }
                                className="pricing-input"
                              />
                            </td>
                            ...
                            <td>
                              <input
                                ...
                                onChange={(e) =>
                                  updatePricingField(model, 'cacheReadPer1MTokens', e.target.value)
                                }
                                className="pricing-input"
                              />
                            </td>
