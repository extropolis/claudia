        ...
        >
            {task ? (
                ...
                <div
                    ...
                    /* The single-pane empty state IS the old full-panel
                       "no task selected" view, so it keeps that hook; extra
                       panes get their own so tests can tell them apart. */
                    data-testid={isOnlyPane ? 'no-task-selected' : 'pane-empty'}
                >
