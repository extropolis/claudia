...
import { createTestEnv, initRepo, git, waitFor, type TestEnv, type WSClient } from './helpers/ws-harness.js';
...
describe('workspace:create / delete / rename', () => {
...
describe('workspace:reorder / setOrder', () => {
...
describe('workspace:systemPrompt get/set', () => {
...
describe('workspace:references add / toggle / remove', () => {
    let refPath: string;
...
describe('workspace:recent list / clear', () => {
...
describe('workspace:autoWorktree', () => {
...
describe('worktree:create / list / remove / prune', () => {
    let wtPath: string;
...
describe('git:push (local bare remote — no network)', () => {
