...
describe('cron:list / update / run / delete', () => {
    let cronId: string;
...
describe('shell:create / input / resize / close', () => {
...
describe('protocol robustness: malformed input must never take down the server', () => {
...
describe('supervisor + tunnel handlers that need no network', () => {
