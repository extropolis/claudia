...
export default class SapAiCorePlugin {
    constructor() {
        // Load manifest
    ...
    getTaskEnvironment(config) {
        // Set ANTHROPIC_BASE_URL to point to the SAP AI Core proxy
        // The proxy runs at the root and is mounted at /v1 and /anthropic by the plugin manager
        return {
